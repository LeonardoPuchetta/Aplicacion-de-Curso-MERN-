...
import {Row ,Col,Card,Button,notification,Rate}from 'antd';
...
function Course(props){
    ...
    const [courseInfo, setsCourseInfo] = useState({});
    ...
    return (
        <a href={urlCourse} target='_blank' rel='noopener noreferrer'>
            <Card cover= {<img src = {courseInfo.image_480x270} 
                 alt = {courseInfo.title}/>}>
                    ...
                    <div className='courses-list__course-footer'>
                        ...
                        <span>{course.price? `${course.price}U$S`:courseInfo.price}</span>
